...
class S {
  ...
  /// `Now Playing`
  String get home_page_tap_bar_now_playing_title {
    return Intl.message(
      'Now Playing',
      name: 'home_page_tap_bar_now_playing_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Top Rated`
  String get home_page_tap_bar_top_rated_title {
    return Intl.message(
      'Top Rated',
      name: 'home_page_tap_bar_top_rated_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Find Movie`
  String get home_page_tap_bar_search_movie_title {
    return Intl.message(
      'Find Movie',
      name: 'home_page_tap_bar_search_movie_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Write a movie name`
  String get home_page_tap_bar_search_movie_hint_text_field_title {
    return Intl.message(
      'Write a movie name',
      name: 'home_page_tap_bar_search_movie_hint_text_field_title',
      desc: '',
      args: [],
    );
  }
  ...
  String get home_page_tap_bar_search_movie_placeholder_msg_title {
    return Intl.message(
      'What is the name of the movie you want to search for?',
      name: 'home_page_tap_bar_search_movie_placeholder_msg_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Movie Details`
  String get movie_details_page_app_bar_title {
    return Intl.message(
      'Movie Details',
      name: 'movie_details_page_app_bar_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Description`
  String get movie_details_page_description_section_title {
    return Intl.message(
      'Description',
      name: 'movie_details_page_description_section_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Genres`
  String get movie_details_page_genres_section_title {
    return Intl.message(
      'Genres',
      name: 'movie_details_page_genres_section_title',
      desc: '',
      args: [],
    );
  }
