...
mixin _$ApiDataState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T? data, T? response) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T? data, T? response)? success,
...
abstract class ApiDataSuccessModel<T> implements ApiDataState<T> {
  const factory ApiDataSuccessModel(
      {final T? data,
      required final T? response}) = _$ApiDataSuccessModelImpl<T>;
